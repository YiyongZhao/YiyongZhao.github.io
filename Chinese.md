...
3. CHENG L, CHEN F, HAN Q, LI M, Tiago Santana Balbuena, __ZHAO Y__*. Phylogenomics as an effective approach to untangle cross-species hybridization event: a case study in the family Nymphaeaceae. 2022. ***Frontiers in Genetics***-section in computational genomics (**IF=4.772**)
